...
PROMPT='${fg_bold[white]%}[%{$reset_color%} %{$fg_bold[red]%}%n@%M%{$reset_color%} ${fg_bold[white]%}|%{$reset_color%} %{$fg_bold[green]%}%/%{$reset_color%}$(git_prompt_info) %{$fg_bold[white]%}]:%{$reset_color%} '
